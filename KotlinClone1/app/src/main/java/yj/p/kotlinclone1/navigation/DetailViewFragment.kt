...
class DetailViewFragment : Fragment() {
    ...
    inner class DetailViewRecyclerViewAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
        ...
        init {
            ...
            firestore?.collection("images")?.orderBy("timestamp")?.addSnapshotListener{querySnapshot: QuerySnapshot?, error: FirebaseFirestoreException? ->
                contentDTOs.clear()
        ...
        override fun onBindViewHolder(p0: RecyclerView.ViewHolder, p1: Int) {
            ...
            // Explain of content
            viewholder.detailviewitem_explaine_textview.text = contentDTOs[p1].explain
